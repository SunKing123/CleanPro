...
public class GeTuiPushClient implements IPushClient {
    ...
    public void bindAlias(String alias) {
        ...
        PushMsgHandler.transmitCommandResult(context, GeekPush.TYPE_BIND_ALIAS,
                isSuccess ? GeekPush.RESULT_OK : GeekPush.RESULT_ERROR, null, alias,
    ...
    public void unBindAlias(String alias) {
        ...
        PushMsgHandler.transmitCommandResult(context, GeekPush.TYPE_UNBIND_ALIAS,
                isSuccess ? GeekPush.RESULT_OK : GeekPush.RESULT_ERROR, null, alias,
    ...
    public void addTag(String tag) {
        this.tags.add(tag);
        setTag(true, tag);
        LogUtils.i("addTag-->当前标签：" + this.tags);
    }
    ...
    public void deleteTag(String tag) {
        ...
        setTag(false, tag);
        LogUtils.i("deleteTag-->当前标签：" + this.tags);
    }
    ...
    private void sendAddTagEvent(boolean isAdd, String tag, int eventType) {
        ...
        PushMsgHandler.transmitCommandResult(context, isAdd ? GeekPush.TYPE_ADD_TAG : GeekPush.TYPE_DEL_TAG, eventType, null, tag, text);
    }
