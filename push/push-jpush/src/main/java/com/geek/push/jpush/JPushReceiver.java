...
public class JPushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(action)) {
            ...
            PushMsgHandler.transmitMessage(context, message, extra, null);
            ...
            try {
                PushMsgHandler.transmitNotification(context, notifyId, title, content, null,
                        JsonUtils.toMap(new JSONObject(extra)));
            } catch (JSONException localJSONException2) {
                localJSONException2.printStackTrace();
                PushMsgHandler.transmitNotification(context, notifyId, title, content, extra, null);
            }
            ...
            int notifyId = bundle.getInt(JPushInterface.EXTRA_NOTIFICATION_ID);
            try {
                PushMsgHandler.transmitNotificationClick(context, notifyId, title, content, null,
                        JsonUtils.toMap(new JSONObject(extra)));
            } catch (JSONException localJSONException1) {
                localJSONException1.printStackTrace();
                PushMsgHandler.transmitNotificationClick(context, notifyId, title, content, extra, null);
            }
