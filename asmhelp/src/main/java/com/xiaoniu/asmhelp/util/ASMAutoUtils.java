...
import com.xiaoniu.asmhelp.vivoHelp.VivoPermissionUtils;
            ...
            case PERMISSION_FLOAT:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M || PhoneRomUtils.getPhoneModel().equalsIgnoreCase("vivo X7Plus")
                    ...
                    isAllow = VivoPermissionUtils.getFloatPermissionStatusOld(mContext) == 0;
                        ...
                        || PhoneRomUtils.getPhoneModel().equalsIgnoreCase("V1809T") || PhoneRomUtils.getPhoneModel().equalsIgnoreCase("V1831A")
                        || PhoneRomUtils.getPhoneModel().equalsIgnoreCase("vivo x20a")
