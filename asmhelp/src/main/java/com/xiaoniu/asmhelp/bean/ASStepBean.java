...
public class ASStepBean implements Serializable {
    ...
    public void setOutBounds(Rect outBounds) {
        this.outBounds = outBounds;
    }

    public int getAlterWindowGuide() {
        return alterWindowGuide;
    }

    public void setAlterWindowGuide(int alterWindowGuide) {
        this.alterWindowGuide = alterWindowGuide;
    }
    ...
    public void setFindMatchText(boolean findMatchText) {
        this.findMatchText = findMatchText;
    }

    public String[] getFindMatchTexts() {
        return findMatchTexts;
    }

    public void setFindMatchTexts(String[] findMatchTexts) {
        this.findMatchTexts = findMatchTexts;
    }
}