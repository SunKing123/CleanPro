...
public class PushMsgHandler {
     ...
     * @param extraMsg
     */
    public static void transmitMessage(Context context, String msg, String msgId,
                                       String extraMsg, Map<String, String> keyValue) {
        transmit(context, PushAction.RECEIVE_MESSAGE
                , new PushMsg(0, null, null, msg, msgId, extraMsg, keyValue));
    }
     ...
     */
    public static void transmitNotificationClick(Context context, int notifyId, String title
            , String content, String msgId, String extraMsg, Map<String, String> keyValue) {
        transmit(context, PushAction.RECEIVE_NOTIFICATION_CLICK
                , new PushMsg(notifyId, title, content, null, msgId, extraMsg, keyValue));
    }
