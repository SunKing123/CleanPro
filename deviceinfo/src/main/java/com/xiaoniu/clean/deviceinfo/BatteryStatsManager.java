...
public class BatteryStatsManager {
    ...
    private String TAG = "BatteryStatsManager";
    ...
    private static BatteryStatsManager sInstance;
    ...
    public static BatteryStatsManager getInstance() {
        if (sInstance == null) {
            synchronized (BatteryStatsManager.class) {
                if (sInstance == null) {
                    sInstance = new BatteryStatsManager();
                }
            }
        }
        return sInstance;
