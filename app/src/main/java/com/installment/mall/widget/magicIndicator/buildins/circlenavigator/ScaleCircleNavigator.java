package com.installment.mall.widget.magicIndicator.buildins.circlenavigator;
...
import com.installment.mall.widget.magicIndicator.buildins.ArgbEvaluatorHolder;
import com.installment.mall.widget.magicIndicator.buildins.UIUtil;
...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public void setmMinRadius(int mMinRadius) {
