package com.installment.mall.utils.luban;
...
import static com.installment.mall.utils.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    public static Luban get(Context context) {
        if (INSTANCE == null) INSTANCE = new Luban(getPhotoCacheDir(context));
        return INSTANCE;
    }
