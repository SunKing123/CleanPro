...
//    public static String sDomain = CoolingApi.APP_DOMAIN;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(BuildConfig.BASE_HOST)
...
//                    RetrofitUrlManager.getInstance().putDomain(Api.WEATHER_DOMAIN_NAME, Api.BASE_WEATHER_API);
                })
