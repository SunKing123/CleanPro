...
public class CountDownView  extends AppCompatTextView {
    ...
    public CountDownView(Context context, AttributeSet attrs) {
        ...
        unClickColor = ta.getColor(R.styleable.CountDown_unClickColor, Color.parseColor("#ffffff"));
        unClickText = ta.getString(R.styleable.CountDown_unClickText);
        suffixText = ta.getString(R.styleable.CountDown_suffixText);
        clickedNumColor = ta.getColor(R.styleable.CountDown_clickedNumColor, Color.WHITE);
        suffixColor = ta.getColor(R.styleable.CountDown_suffixColor, Color.parseColor("#ffffff"));
