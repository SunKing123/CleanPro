...
public class NetWorkUtils {
    ...
    public static boolean isNetConnected() {
        boolean i = false;
        NetworkInfo localNetworkInfo = ((ConnectivityManager) AppApplication.getInstance()
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ...
        return ((ConnectivityManager) AppApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
