...
public class NotificationUtils {
    ...
    public static NotificationManager getManager() {
        return (NotificationManager) ContextUtils.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
    }

    public static void sendNotification(String title, String content, PendingIntent pendingIntent) {
    ...
    public static NotificationCompat.Builder getNotification(String title, String content) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            builder = new NotificationCompat.Builder(ContextUtils.getContext(), CHANNEL_ID);
        } else {
        ...
        builder.setLargeIcon(BitmapFactory.decodeResource(ContextUtils.getContext().getResources(), R.drawable.applogo));
        //点击自动删除通知
        builder.setAutoCancel(true);
        return builder;
    }

    public static void sendNotification(int notifyId, String title, String content) {
        NotificationCompat.Builder builder = getNotification(title, content);
