 ...
 * 图片分类
 */
public class WXImgChatFragment extends BaseFragment {
    ...
    public void onEvent(WXImgChatEvent wxImgChatEvent) {
        List<FileTitleEntity> lists = (List<FileTitleEntity>) wxImgChatEvent.object;
