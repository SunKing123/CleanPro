...
public class FullPopLayerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if(null!=adInfo){
            StatisticsUtils.clickAD("ad_close_click", "关闭点击", "1", adInfo.getAdId(), adInfo.getAdSource(), "external_insert_screen_full_screen_page", "external_insert_screen_full_screen_page", adInfo.getAdTitle());
        }
        finish();
    }
}
