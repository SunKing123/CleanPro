 ...
 * @date 2019/12/21
 */
public class AQYActivity extends SimpleActivity {
    ...
    protected void initView() {
        //启动爱奇艺
        isStarted = false;
        StatisticsUtils.trackDivideClick("split_icon_click", "分身图标点击", "split_icon", "split_icon","爱奇艺");
    ...
    protected void onResume() {
        super.onResume();
        if (!isStarted) {
            SystemUtils.openApp(getApplicationContext(), "com.qiyi.video");
            isStarted = true;
            //唤起本地service
