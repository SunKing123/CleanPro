 ...
 * @author XiLei
 * @date 2019/10/14.
 * description：清理完成广告自渲染页
 */
public class CleanFinishAdvertisementActivity extends BaseActivity implements NativeExpressAD.NativeExpressADListener, View.OnClickListener {
...
//    private TextView mTvQl;
    ...
    protected void initViews(Bundle savedInstanceState) {
       /* mToolBar = findViewById(R.id.toolBar);
        ...
        View header = LayoutInflater.from(this).inflate(R.layout.layout_finish_advertisement_head, findViewById(android.R.id.content), false);
