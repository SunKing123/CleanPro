 ...
 * @date 2019/12/21
 */
public class JRTTActivity extends SimpleActivity {
    ...
    protected void initView() {
        //启动微信
        isStarted = false;
        StatisticsUtils.trackDivideClick("split_icon_click", "分身图标点击", "split_icon", "split_icon","今日头条");
    ...
    protected void onResume() {
        super.onResume();
        if (!isStarted) {
            SystemUtils.openApp(getApplicationContext(), "com.ss.android.article.news");
            isStarted = true;
            //唤起本地service
