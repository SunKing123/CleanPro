 ...
 * ================================================
 */
public class BindPhoneManualActivity extends BaseActivity<BindPhoneManualPresenter> implements BindPhoneManualContract.View {
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        titleLayout.setLeftTitle("登录3").setBgColor(R.color.common_white);
    }
