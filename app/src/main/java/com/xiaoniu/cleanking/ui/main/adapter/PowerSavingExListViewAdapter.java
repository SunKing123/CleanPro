...
public class PowerSavingExListViewAdapter extends BaseExpandableListAdapter {
    ...
    public PowerSavingExListViewAdapter(Context context, ExpandableListView listView) {
        mListView = listView;
        mContext = context;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        DockingExpandableListViewAdapter.ChildViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext)
                    .inflate(R.layout.level1_item_list, null);
            holder = new DockingExpandableListViewAdapter.ChildViewHolder();
            ...
            holder = (DockingExpandableListViewAdapter.ChildViewHolder) convertView.getTag();
        }
        //名称
