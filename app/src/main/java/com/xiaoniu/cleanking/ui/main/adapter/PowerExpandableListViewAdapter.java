 ...
 * 一键清理详情的列表Adapter
 */
public class PowerExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public PowerExpandableListViewAdapter(Context context, ExpandableListView listView) {
        mListView = listView;
        mContext = context;
    }
