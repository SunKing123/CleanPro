...
//    public static final String CLEAN_FINISH_ID = "4070988415680442";
    ...
    public static final String AD_HOME_CENTER = "homepage_ad_4";//首页中间广告
    ...
    public static final String AD_RETAIN_THE_POP_UP_WINDOW = "retain_the_pop_up_window";//挽留弹框广告位
    ...
    //快捷方式加速完成页开关
    public static final String KEY_WIDGET_ACC_FINISH = "page_widget_acc_finish_3.3";
