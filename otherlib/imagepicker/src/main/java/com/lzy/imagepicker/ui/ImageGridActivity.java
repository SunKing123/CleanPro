...
//            mBtnOk.setTextColor(ContextCompat.getColor(this, R.color.ip_text_primary_inverted));
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.color_7C7A7A));
            mBtnOk.setBackgroundResource(R.mipmap.button_select);
        } else {
//            mBtnOk.setText(getString(R.string.ip_complete));
            mBtnOk.setEnabled(false);
            mBtnPre.setEnabled(false);
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.color_BFBFBF));
            mBtnOk.setBackgroundResource(R.mipmap.button_unselected);
