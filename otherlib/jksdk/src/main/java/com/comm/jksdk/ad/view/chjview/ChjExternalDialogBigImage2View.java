...
public class ChjExternalDialogBigImage2View extends CHJAdView {
    // 广告实体数据
    ...
    public ChjExternalDialogBigImage2View(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.chj_ad_external_dialog_big_image2_layout;
    }
