...
public class YlhFullBigImgIcTvBtCenterAdView extends YlhAdView {
    // 广告实体数据
    ...
    public YlhFullBigImgIcTvBtCenterAdView(Context context) {
        super(context);
    ...
    public int getLayoutId() {
        return R.layout.ylh_full_ad_big_ic_tv_bt_center_layout;
    }
