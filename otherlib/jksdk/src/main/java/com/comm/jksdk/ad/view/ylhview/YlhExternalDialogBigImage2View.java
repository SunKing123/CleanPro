...
public class YlhExternalDialogBigImage2View extends YlhAdView {
    // 广告实体数据
    ...
    public YlhExternalDialogBigImage2View(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.ylh_ad_external_dialog_big_image2_layout;
    }
