...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mPressedTextColor = a.getColor(R.styleable.StateButton_sb_pressedTextColor, mNormalTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateButton_sb_unableTextColor, mNormalTextColor);
        setTextColor();
        ...
        mPressedBackgroundColor = a.getColor(R.styleable.StateButton_sb_pressedBackgroundColor, mNormalBackgroundColor);
        mUnableBackgroundColor = a.getColor(R.styleable.StateButton_sb_unableBackgroundColor, mNormalBackgroundColor);
        int startColor = a.getColor(R.styleable.StateButton_sb_normalBackgroundOrientationStart, 0);
        int endColor = a.getColor(R.styleable.StateButton_sb_normalBackgroundOrientationEnd, 0);

        if (startColor != 0 && endColor != 0) {
            mNormalBackground =new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT,new int[]{startColor,endColor});
        } else {
        ...
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_sb_pressedStrokeWidth, mNormalStrokeWidth);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_sb_unableStrokeWidth, mNormalStrokeWidth);
        mNormalStrokeColor = a.getColor(R.styleable.StateButton_sb_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateButton_sb_pressedStrokeColor, mNormalStrokeColor);
        mUnableStrokeColor = a.getColor(R.styleable.StateButton_sb_unableStrokeColor, mNormalStrokeColor);
        setStroke();
